        ...
        <div className="header__inner">
          <div className="header__logo-box">
            <a className="header__logo-link" href="/">
              <svg className='header__logo' fill="#fff" width="60px" height="60px" viewBox="0 0 32 32" version="1.1">
                <title>film</title>
          ...
          <ui className="header__list">
            <li className="header__list-item">
              <a href="/" className="header__list-item__link">Главная</a>
            </li>
            <li className="header__list-item">
              <a href="#" className="header__list-item__link">Фильмы</a>
            </li>
            <li className="header__list-item">
